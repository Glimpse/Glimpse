...
namespace Glimpse.Test.AspNet.PipelineInspector
{
    public class RoutesInspectorShould
    {
        ...
        { 
            ...
            context.ProxyFactory.Setup(pf => pf.WrapClass((System.Web.Routing.Route)System.Web.Routing.RouteTable.Routes[0], It.IsAny<IEnumerable<IAlternateImplementation>>(), null, It.IsAny<object[]>())).Returns(route1);
            context.ProxyFactory.Setup(pf => pf.WrapClass((System.Web.Routing.Route)System.Web.Routing.RouteTable.Routes[1], It.IsAny<IEnumerable<IAlternateImplementation>>(), null, It.IsAny<object[]>())).Returns(route2);
            context.ProxyFactory.Setup(pf => pf.WrapClass(System.Web.Routing.RouteTable.Routes[2], It.IsAny<IEnumerable<IAlternateImplementation>>(), null, null)).Returns(route3);

            sut.Setup(context);

            context.ProxyFactory.Verify(pf => pf.WrapClass(It.IsAny<System.Web.Routing.Route>(), It.IsAny<IEnumerable<IAlternateImplementation>>(), It.IsAny<IEnumerable<object>>(), It.IsAny<IEnumerable<object>>()), Times.AtLeastOnce());
            context.ProxyFactory.Verify(pf => pf.WrapClass(It.IsAny<System.Web.Routing.RouteBase>(), It.IsAny<IEnumerable<IAlternateImplementation>>(), It.IsAny<IEnumerable<object>>(), null), Times.AtLeastOnce());
        }
