                        ...
                        structure = {
                            ...
                            popup: {
                                render: function(details) {
                                    ...
                                    html += '<table class="glimpse-hud-summary glimpse-hud-summary-right" style="max-width:120px"><tr><td width="1" class="glimpse-hud-listing-overflow">' + rendering.item(structure.layout.popup.host, details) + '</td></tr><tr><td class="glimpse-hud-listing-overflow">' + rendering.item(structure.layout.popup.principle, details)  + '</td></tr></table></div>';
                            ...
                            defaults: {
                                ...
                                host: { title: 'Host', description: 'Server that responded to the request', visible: true, size: 2, position: 1, align: 1, postfix: '', getLayoutData: function(details) { return '<div class="glimpse-hud-listing-overflow" style="width:120px;">' + details.environment.data.serverName + '</div>'; } }, 
                                principle: { title: 'Principle', description: 'Principle that is currently logged in for this session', visible: function(details) { return details.environment.data.user + 'vdh_ant'; }, size: 2, position: 1, align: 1, postfix: '', getLayoutData: function(details) { return '<div class="glimpse-hud-listing-overflow" style="width:120px;">' + details.environment.data.user + 'vdh_ant</div>'; } }
                            },
                            layout: {
                                mini: {
                                    request: {},
