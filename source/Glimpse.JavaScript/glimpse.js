...
var glimpse = (function ($, scope) {
    ...
    var //Private
        ...
        toolbarController = function () {
            var //Support
                isPopup = function() {
                    return window.location.href.indexOf(data.currentMetadata().resources.popup) > -1;
                },
                wireListeners = function() {
                ...
                openPopup = function () { 
                    ...
                    var path = data.currentMetadata().resources.popup,
