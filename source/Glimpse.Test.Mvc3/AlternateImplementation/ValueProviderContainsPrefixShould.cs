...
namespace Glimpse.Test.Mvc3.AlternateImplementation
{
    ...
    public abstract class ValueProviderContainsPrefixShould<T> where T : class
    {
        ...
        [Theory, AutoMock]
        public void ProceedAndReturnWithRuntimePolicyOff(ValueProvider<T>.ContainsPrefix sut, IAlternateImplementationContext context)
        {
        ...
        [Theory, AutoMock]
        public void ProceedAndPublishMessageWithRuntimePolicyOn(ValueProvider<T>.ContainsPrefix sut, IAlternateImplementationContext context)
        {
