...
$(document).ready(function () {
    ...
    var scenarioFifteenMetadata = [
            [ { data : [ { data : 0, key : true, align : 'right' }, { data : 1, align : 'right' }, { data : 2, align : 'right', post : ' ms' }, { data : 3, align : 'right', pre : 'T+ ', post : ' ms' } ], width : '200px' }, { data : 4, isCode : true, codeType : 'sql' } ]
        ];
