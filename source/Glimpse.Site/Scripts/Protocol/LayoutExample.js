...
$(document).ready(function () {
    ...
    var scenarioFourteenMetadata = [
            [ { data : 0, width : '200px', key : true, align : 'right' }, { data : 1, rspan : 3} ],
            [ { data : 2, align : 'right' } ],
            [ { data : '{{3}} - {{4}}', align : 'right' } ]
        ];
    ...
    var scenarioFifteenMetadata = [
            [ { data : 0, width : '200px', key : true, align : 'right' }, { data : 4, rspan : 4, isCode : true, codeType : 'sql' } ],
            [ { data : 1, align : 'right' } ],
            [ { data : 2, align : 'right', post : ' ms' } ],
            [ { data : 3, align : 'right', pre : '+ ', post : ' ms' } ]
        ];
