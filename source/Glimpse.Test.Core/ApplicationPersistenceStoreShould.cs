...
namespace Glimpse.Test.Core
{
    public class ApplicationPersistenceStoreShould:IDisposable
    {
        ...
        public void Persist()
        {
            ...
            Store.Save(new GlimpseRequest(Guid.NewGuid(), Store.RequestMetadataMock.Object, pluginData, 0));
        ...
        public void GetGlimpseMetadataById()
        {
            ...
            var metadata = new GlimpseRequest(requestId, Store.RequestMetadataMock.Object, new Dictionary<string, TabResult>(), 0);
        ...
        public void GetGlimpseMetadataByIdWithMisMatch()
        {
            ...
            Store.Save(new GlimpseRequest(Guid.NewGuid(), Store.RequestMetadataMock.Object, new Dictionary<string, TabResult>(), 0));
        ...
        public void GetTopWithFewerThanRequested()
        {
            ...
            var metadata1 = new GlimpseRequest(Guid.NewGuid(), Store.RequestMetadataMock.Object, pluginData, 0);
            var metadata2 = new GlimpseRequest(Guid.NewGuid(), Store.RequestMetadataMock.Object, pluginData, 0);
            var metadata3 = new GlimpseRequest(Guid.NewGuid(), Store.RequestMetadataMock.Object, pluginData, 0);
            var metadata4 = new GlimpseRequest(Guid.NewGuid(), Store.RequestMetadataMock.Object, pluginData, 0);
            var metadata5 = new GlimpseRequest(Guid.NewGuid(), Store.RequestMetadataMock.Object, pluginData, 0);
        ...
        public void GetOnePluginsData()
        {
            ...
            var id = Guid.NewGuid();
            var metadata = new GlimpseRequest(id, Store.RequestMetadataMock.Object, pluginData, 0);
