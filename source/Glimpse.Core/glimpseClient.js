...
if (window.jQueryGlimpse) { (function ($) {
    ...
    $.extend($.glimpseProcessor, {
        ...
        applyPostRenderTransforms: function (scope) {
            ...
            //Stripping 
            $('.even > td, .even > tr > td, .even > th, .even > tr > th', scope).addClass('even');
            $('.even > .glimpse-preview-table td').addClass('even'); 
            $('.odd > td, .odd > tr > td, .odd > th, .odd > tr > th', scope).addClass('odd');
            $('.odd > .glimpse-preview-table td').addClass('odd');
