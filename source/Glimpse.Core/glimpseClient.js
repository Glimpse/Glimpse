...
if (window.jQueryGlimpse) { (function ($) {
    ...
    $.extend($.glimpseProcessor, {
        ...
        buildHeading: function (url, clientName, type) {
            ...
            return '<span class="glimpse-snapshot-type">' + clientName + ((type.length > 0) ? ' (' + type + ')' : '') + '&nbsp;</span><span class="glimpse-switch-holder">' + url + '</span>';
        },
        ...
        adjustLayout: function () {
            ...
            if (environments) {
                ...
                if (currentEnvironment) {
                    $('.glimpse-title .glimpse-switch-holder', mainHolder)
                        .prepend('<span class="glimpse-switch glimpse-switch-drop">' + currentEnvironment + '<span class="glimpse-switch-arrow-holder"><span class="glimpse-switch-arrow"></span></span></span><div class="glimpse-switch glimpse-switch-over"><div>Switch Servers</div>' + environmentsList + '</div>');
                    $('.glimpse-title .glimpse-switch-holder .glimpse-switch-over', mainHolder).mouseleave(function () {
                        $('.glimpse-switch-over', mainHolder).hide();
                    });
                    $('.glimpse-title .glimpse-switch-holder .glimpse-switch', mainHolder).mouseover(function () {
