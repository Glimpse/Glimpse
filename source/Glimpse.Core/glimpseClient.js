...
if (window.jQueryGlimpse) { (function ($) {
    ...
    $.extend($.glimpseServerSwitcher, {
        ...
        adjustLayout: function (tabStrip, panelHolder) {
            ...
            var environments = g.static.data._metadata.request.environmentUrls
            ...
            if (environments) {
                ...
                if (currentEnvironment) {
                    ...
                    $('.glimpse-title span:last', mainHolder).prepend($('<a/>', { html: currentEnvironment }).hover(function () {
