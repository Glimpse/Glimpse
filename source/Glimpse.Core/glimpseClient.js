...
if (window.jQueryGlimpse) { (function ($) {
    ...
    $.extend($.glimpseProcessor, {
        ...
        buildHeading: function (url, clientName, type) {
            ...
            return '<span class="glimpse-snapshot-type">' + clientName + ((type.length > 0) ? ' (' + type + ')' : '') + '&nbsp;</span><span class="glimpse-enviro-drop">' + url + '</span>';
        },
        ...
        adjustLayout: function () {
            ...
            if (environments) {
                ...
                if (currentEnvironment) {
                    $('.glimpse-title .glimpse-enviro-drop', mainHolder).prepend('<span class="glimpse-drop">' + currentEnvironment + '<span class="glimpse-drop-arrow-holder"><span class="glimpse-drop-arrow"></span></span></span><div class="glimpse-drop-over"><div>Switch Servers</div>' + environmentsList + '</div>');
                    $('.glimpse-title .glimpse-enviro-drop .glimpse-drop-over', mainHolder).mouseleave(function () {
                        $('.glimpse-title .glimpse-enviro-drop .glimpse-drop-over', mainHolder).fadeOut(100);
                    });
                    $('.glimpse-title .glimpse-enviro-drop .glimpse-drop', mainHolder).mouseover(function () {
                        $('.glimpse-title .glimpse-enviro-drop .glimpse-drop-over', mainHolder).fadeIn('fast');
                    });
                }
            }
        }
