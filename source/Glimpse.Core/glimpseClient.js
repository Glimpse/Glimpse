    ...
    $.extend($.glimpseProcessor, {
        ...
        buildStructuredTableCell : function(data, metadataItem, level, tolerance, cellType) {
            ...
            if ($.isArray(metadataItem.data)) {
                ...
                cellContent = that.build(cellContent, level + 1, undefined, tolerance);
