...
if (window.jQueryGlimpse) { (function ($) {
    ...
    $.extend($.glimpseProcessor, {
        ...
        buildStructuredTableCell : function(data, metadataItem, level, cellType, rowIndex) {
            ...
            console.log('<' + cellType + cellAttr + '>' + cellContent + '</' + cellType + '>');
