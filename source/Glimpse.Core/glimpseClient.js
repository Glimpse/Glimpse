...
if (window.jQueryGlimpse) { (function ($) {
    ...
    $.extend($.glimpseAjax, {
        init: function() {
            ...
            //Wire up events 
            $('.glimpse-clear', static.panel).live('click', function() { ga.reset(); });
        },
