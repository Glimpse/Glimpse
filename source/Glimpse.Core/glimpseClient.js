            ...
            if (environments) {
                ...
                if (currentEnvironment) {  
                    $('.glimpse-title span:last', mainHolder)
                        .prepend('<div class="glimpse-switch glimpse-switch-over"><div>Switch Servers</div>' + environmentsList + '</div>')
                        .mouseout(function() {
                            $('.glimpse-switch-over', mainHolder).hide();
                        })
                        .prepend('<a class="glimpse-switch">' + currentEnvironment + '</a>')
                        .mouseover(function() {
