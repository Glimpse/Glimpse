...
var glimpseTimeline = function (scope, settings) { 
    var elements = {},
            ...
            var criteria = { 
                ...
                search = function (c) {
                    ...
                    for (var i = 0; i < settings.events.length; i += 1) {
                        ...
                        //Table elements
                        elements.contentTableHolder.find('tr').eq(i + 1).toggle(show); 
                    }
        ...
        init = function () { 
            ...
            elements.summaryRow.find('.glimpse-tl-band-title').click(function () {
