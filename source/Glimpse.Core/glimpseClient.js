...
//    window.jQueryGlimpse(document).ready(function() { 
//    setTimeout(function() {
//        prettyPrint();  
//        }, 5000);
//    });
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                for (var x = 0; x < metadata.length; x++) {
                    ...
                    for (var y = 0; y < metadata[x].length; y++) {
                        ...
                        if (metadataItem.rspan) { html += ' rowspan="' + metadataItem.rspan + '"'; newTolerance = metadataItem.rspan; };
                        if (metadataItem.codeType) { html += ' data-codeType="' + metadataItem.codeType + '"'; };
