...
pubsub.publish("data.template.processed")});pubsub.subscribe("state.build",function(){d.scope=x;d.holder=d.scope.find(".glimpse-holder");d.opener=d.scope.find(".glimpse-open");d.spacer=d.scope.find(".glimpse-spacer");pubsub.publish("data.elements.processed")})}();stateController=function(){pubsub.subscribe("state.persist",function(){util.cookie("glimpseOptions",settings)});pubsub.subscribe("state.restore",function(){e.extend(settings,util.cookie("glimpseOptions"))});pubsub.subscribe("state.terminate",
