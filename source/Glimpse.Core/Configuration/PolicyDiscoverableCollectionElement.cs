...
namespace Glimpse.Core.Configuration
{
    ...
    {
        public PolicyDiscoverableCollectionElement()
        {
            ContentTypes = new ContentTypeElementCollection();
            StatusCodes = new StatusCodeElementCollection();
            Uris = new RegexElementCollection();
        }
        ...
        /// </value>
        public StatusCodeElementCollection StatusCodes { get; set; }
