...
namespace Glimpse.Core.Resource
{
    public class ConfigurationResource:IResource
    {
        ...
        public IResourceResult Execute(IResourceContext context)
        {
            ...
            content.Append("<script>function toggleCookie(){var mode = document.getElementById('glimpseState'); if (mode.innerHTML==='On'){mode.innerHTML='Off';document.cookie='glimpseState=Off; path=/;';}else{mode.innerHTML='On';document.cookie='glimpseState=On; path=/;';}}</script>");
