    ...
    (function ($) {
        ...
        $.extend($.glimpseAjax, {
            ...
            callFinished: function (ajaxSpy) {
                var ga = this, row = ajaxSpy.logRow, glimpseResponse = ajaxSpy.responseHeaders['X-Glimpse-Debugger'];
                ...
                if (glimpseResponse) {
                    $('.glimpse-ajax-inspect', row).html('<a href="#">Launch</a>').children('a').click(function () {
                        ...
                        $.glimpse.refresh(eval('(' + glimpseResponse + ')'), $.glimpseProcessor.buildHeading(ajaxSpy.url, ajaxSpy.clientName, ga.static.key));
                        return false;
                    });
                }
            },
