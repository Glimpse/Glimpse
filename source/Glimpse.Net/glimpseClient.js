...
if (window.jQuery) {
    ...
    $.extend($.glimpse, {
        ...
        static: {
            ...
            clientName : '',
            html : { plugin: '<div class="glimpse-open"><div class="glimpse-icon"></div></div><div class="glimpse-holder glimpse"><div class="glimpse-resizer"></div><div class="glimpse-bar"><div class="glimpse-icon"></div><div class="glimpse-title"></div><div class="glimpse-buttons"><a href="#" class="glimpse-meta-warning glimpse-button" title="Glimpse has some warnings!"></a><a href="#" class="glimpse-meta-info glimpse-button" title="About Glimpse?"></a><a href="#" title="Pop Out" class="glimpse-popout glimpse-button"></a><a href="#" title="Shutdown/Terminate" class="glimpse-terminate glimpse-button"></a><a href="#" title="Close/Minimize" class="glimpse-close glimpse-button"></a></div></div><div class="glimpse-content"><div class="glimpse-tabs"><ul></ul></div><div class="glimpse-panel-holder"></div></div></div>' },
    ...
    $.extend($.glimpseMeta, { 
        ...
        adjustProtocol : function(data) {
            ...
            //Info tab
            data[gm.static.key.info] = '<div class="glimpse-info-title">Glimpse</div><div>v0.81</div><div class="glimpse-info-quote">"What Firebug is for the client, Glimpse is for the server"</div><div>Created by <strong>Anthony van der Hoorn</strong> (<a href="http://twitter.com/anthony_vdh">@anthony_vdh</a>) and <strong>Nik Molnar</strong> (<a href="http://twitter.com/nikmd23">@nikmd23</a>) - &copy; getglimpse.com 2011</div><div class="glimpse-info-more">For more info see <a href="http://getGlimpse.com">getGlimpse.com</a></div><div>Have a <em>feature</em> request? <a href="http://getglimpse.uservoice.com">Submit the idea</a>. &nbsp; &nbsp; Found an <em>error</em>? <a href="https://github.com/glimpse/glimpse/issues">Help us improve</a>. &nbsp; &nbsp; Have a <em>question</em>? <a href="http://twitter.com/#search?q=%23glimpse">Tweet us using #glimpse</a>.</div>';
        },
        adjustLayout : function(tabStrip, panelHolder) {
